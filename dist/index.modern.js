...
var _templateObject;
var Layer = React.memo(function (_ref) {
  var index = _ref.index,
    opacity = _ref.opacity,
    transform = _ref.transform,
    children = _ref.children;
  return React.createElement(StyledLayer, {
...
var Layers = React.memo(function (_ref) {
  ...
  var getDirection = React.useCallback(function (pct) {
  ...
  var renderLayers = useMemo(function () {
  ...
  return React.createElement(Fragment, null, renderLayers);
});

var _templateObject$1, _templateObject2;
var Ztext = function Ztext(props) {
  var layersWrapperRef = React.useRef(null);
  var tilt = React.useCallback(function (xPct, yPct) {
  ...
  }, React.createElement(LayersWrapper, {
